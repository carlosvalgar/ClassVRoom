# Generated by Django 3.2 on 2022-03-11 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='classroomvr.exercise')),
        ...
        migrations.AddField(
            model_name='user',
            name='permissions',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='classroomvr.privacypolicy'),
        ),
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='classroomvr.role'),
        ),
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='classroomvr.school'),
        ),
        migrations.AddField(
            model_name='user',
